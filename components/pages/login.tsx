      ...
      <div className="flex w-full flex-col justify-between bg-white px-12 py-10 lg:w-[45%]">
        ...
        <div className="mx-auto w-full max-w-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {/* Error */}
            {error && (
              <div className="rounded-md bg-red-50 border border-red-100 px-3.5 py-2.5 text-sm text-red-600">
                {error}
              </div>
            )}
          ...
          <p className="mt-6 text-center text-xs text-[#9CA3AF]">
            首次使用请{" "}
            <button type="button" className="text-[#2563EB] hover:underline transition-colors">
              联系管理员获取账号
            </button>
          </p>
        </div>
